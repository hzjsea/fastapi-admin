...
from app.settings import setting  # 导入环境的方式1
from app.settings import config2  # 导入环境的方式2
from app.api.v1 import api, prefix
from app.utils.custom_exc import PostParamsError, TokenAuthError
from app.logsX import logger
